...
class SuggestionsControllerTest < ActionController::TestCase
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post :create, suggestion: { description: @suggestion.description, suggester_id: @suggestion.suggester_id, vote_count: @suggestion.vote_count }
    end
  ...
  test "should update suggestion" do
    patch :update, id: @suggestion, suggestion: { description: @suggestion.description, suggester_id: @suggestion.suggester_id, vote_count: @suggestion.vote_count }
    assert_redirected_to suggestion_path(assigns(:suggestion))
  end
